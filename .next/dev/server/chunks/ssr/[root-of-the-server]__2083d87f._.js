...
function AddClientPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { data: authUser, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.admin.createUser({
                email,
                password,
                email_confirm: true
            });
            ...
            // 2️⃣ Insert profile
            const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').insert({
                user: userId,
                role: 'client',
                full_name: fullName
            });
            ...
            const { error: companyError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('companies').insert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2083d87f._.js.map