...
"[project]/src/app/manager/dashboard/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ManagerDashboard() {
    ...
    const fetchData = async ()=>{
        ...
        const { data: profileData, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('user, full_name, role').eq('role', 'client');
        if (profileError) {
        ...
        const { data: companyData, error: companyError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('companies').select('id, company_name, created_at, user').in('user', clientUserIds).order('created_at', {
            ascending: false
        });
        if (companyError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf57064b._.js.map