...
(()=>{
    const e = new Error("Cannot find module '@/lib/prompts/loadPrompts'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/lib/prompts/schemas'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2e5da3f._.js.map