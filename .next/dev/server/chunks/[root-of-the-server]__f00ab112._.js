...
"[project]/src/lib/dedup/embedText.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/dedup/similarity.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/dedup/deduplicateArticles.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$embedText$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/dedup/embedText.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$similarity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/dedup/similarity.ts [app-route] (ecmascript)");
;
;
...
async function deduplicateArticles(articles) {
    ...
    for (const article of articles){
        const emb = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$embedText$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["embedText"])(article.content);
        let isDuplicate = false;
        for(let i = 0; i < embeddings.length; i++){
            const sim = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$similarity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cosineSimilarity"])(emb, embeddings[i]);
    ...
    console.log(`[DEDUP] ✅ Reduced ${articles.length} → ${kept.length}`);
    return kept;
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$deduplicateArticles$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/dedup/deduplicateArticles.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$embedText$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/dedup/embedText.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$similarity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/dedup/similarity.ts [app-route] (ecmascript)");
;
;
...
async function processAndStoreArticles({ companyId, context, metric, searchResults }) {
  ...
  -------------------------------------------------- */ const scrapeTasks = [];
            ...
            for (const article of articles){
                scrapeTasks.push(async ()=>{
                    ...
                    try {
                        ...
                        skipped++;
                        console.error(`[SCRAPE ERROR] ❌ ${article.title}: ${err.message}`);
                    }
                });
            }
        }
    }
    console.log(`[PROCESS] ⚙️ Scraping ${scrapeTasks.length} articles`);
    ...
    console.log(`[PROCESS] ✅ Scraped ${scrapedArticles.length} articles`);
    /* --------------------------------------------------
     2️⃣ DEDUP CURRENT RUN (SEMANTIC)
  -------------------------------------------------- */ console.log(`[DEDUP] 🔎 Deduplicating current batch`);
    const deduped = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$deduplicateArticles$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deduplicateArticles"])(scrapedArticles.map((a)=>({
            title: a.title,
            content: a.content
        })));
    const dedupedArticles = scrapedArticles.filter((a)=>deduped.some((d)=>d.content === a.content));
    console.log(`[DEDUP] ✅ Reduced ${scrapedArticles.length} → ${dedupedArticles.length}`);
    /* --------------------------------------------------
     3️⃣ LOAD EXISTING ARTICLES FOR DB DEDUP
  -------------------------------------------------- */ const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('articles').select('article_content').eq('company_id', companyId).limit(200);
    const existingEmbeddings = existing ? await Promise.all(existing.map((a)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$embedText$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["embedText"])(a.article_content))) : [];
    /* --------------------------------------------------
     4️⃣ EVALUATE + STORE
  -------------------------------------------------- */ const rowsToUpsert = [];
    for (const article of dedupedArticles){
        ...
        const embedding = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$embedText$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["embedText"])(article.content);
        const isDuplicateInDB = existingEmbeddings.some((e)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dedup$2f$similarity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cosineSimilarity"])(e, embedding) >= DB_SIMILARITY_THRESHOLD);
        if (isDuplicateInDB) {
            skipped++;
            console.log(`[DEDUP-DB] ⛔ Skipping duplicate "${article.title}"`);
            continue;
        }
        rowsToUpsert.push({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f00ab112._.js.map